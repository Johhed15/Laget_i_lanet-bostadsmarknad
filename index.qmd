...
format: 
  ...
  gfm:
    ...
    screenshot: true
    prefer-html: true   # <<-- allows HTML widgets to render as screenshots
execute:
  echo: false
  warning: false
  message: false
